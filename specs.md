# <p align="center">City-Hood
City-hood is a web-app that allow its users interact with what ongoing
in thier space
...
## **1. Introduction**
* **1.1. Scope**
    + This document describes an interactive app whereby users can view whats happening around them
* **1.2. Goals**
